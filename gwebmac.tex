...
% Starred forms, for a section a change file touched: the link target stays the
% bare number, and \lapstar (defined below) laps cweave's star past the printed
% number without widening it.
