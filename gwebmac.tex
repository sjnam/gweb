...
\def\Gangle#1#2{$\langle\,$#1\hbox{\eightrm\kern.4em\s{#2}}$\,\rangle$}
\def\X#1#2{\hbox{\Gangle{#2}{#1}}}        % inline reference in code
...
\def\Dr#1#2{\hbox{\Gangle{#2}{#1}${}\equiv{}$}\hskip 3pt}
\def\Dpr#1#2{\hbox{\Gangle{#2}{#1}${}\mathrel{+}\equiv{}$}\hskip 3pt}
