...
#   gwebmac.tex            -> TEXMFDIR/tex/plain/gweb  (default your TEXMFHOME)
...
echo "Installing gwebmac.tex into $GWEBMACDIR ..."
mkdir -p "$GWEBMACDIR"
