...
\def\Grunhead{%
  ...
  \ifodd\pageno
    \hbox to\Gpagewidth{\mainfont\Gsechead\enspace{\Gheadfont\GtitleUP}\hfil
      {\Gheadfont\Ggrouphead}\enspace\folio}%
  \else
    \hbox to\Gpagewidth{\mainfont\folio\enspace{\Gheadfont\Ggrouphead}\hfil
      {\Gheadfont\GtitleUP}\enspace\Gsechead}%
  \fi}
...
\def\pdfpic#1#{\pdfpicaux{#1}}
\def\pdfpicaux#1#2{\pdfximage #1{#2}\pdfrefximage\pdflastximage}
