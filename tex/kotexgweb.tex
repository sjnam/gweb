...
\def\Gsectionword{절}
\def\Gpageword{쪽}
% Running-head font: pair the small roman (cmr8) with a sans hangul (\eightgt,
% Noto Sans) so Korean in the header matches the upper-cased Latin instead of
% clashing with it as the serif body font would.
